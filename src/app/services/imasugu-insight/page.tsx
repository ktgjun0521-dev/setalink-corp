        ...
        <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
          <FadeIn>
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-lg font-medium text-accent-blue md:text-xl">
                データを事業を動かす戦略に変える
              </p>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {[
              ...
              <FadeIn key={i} delay={i * 100}>
                <div className="flex h-full flex-col items-center justify-center rounded-2xl border border-border bg-white p-8 text-center transition-all duration-300 hover:border-accent-blue/30 hover:shadow-md">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2 lg:gap-8">
            {features.map((feature, i) => (
              <FadeIn key={feature.title} delay={i * 100}>
                <div className="group flex gap-5 rounded-2xl border border-border bg-white p-8 transition-all duration-300 hover:border-accent-blue/30 hover:shadow-md hover:-translate-y-1">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-accent-blue">
